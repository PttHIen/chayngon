...
<?php if (isset($_SESSION['id'])) { ?>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="chatbox"
                                     style="position:relative; height: 350px; border:1px solid #eee; border-radius: 3px; overflow-x: hidden;">
                                    <?php if (isset($_GET['rec_id'])) { ?>

                                        <button type="button" onClick="showchat()"
                                                class="btn btn-primary btn-sm refreshbtn">Refresh
                                        </button>
                                        <div id="chatbox"><?php
                            ...
                            <div class="col-md-12 col-sm-12" style="margin-top: 20px;">
                                ...
                                <?php if (isset($_GET['rec_id'])) { ?>
                                    ...
                                    <input type="hidden" id="receiver_id" value="<?php echo $_GET['rec_id']; ?>"
                                           name="receiver_id"/>
                                    <input type="hidden" id="sender_id" value="8" name="sender_id"/>
                                    <input type="hidden" id="user_id" value="8" name="user_id"/>
                                    <input type="hidden" id="created" value="<?php echo date("Y-m-d H:m:s"); ?>"
                                           name="created"/>
                                    <div class="">
                                        ...
                                        <div class="col-md-3 col-sm-12" style="padding-right: 0;">
                                            <input type="button" class="btn btn-primary" value="Reply"
                                                   onClick="sendchat()" style="width: 100%;">
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
    ...
    <script>
        ...
        function goData(snapshot) {
            ...
            var $message_main_receiver = $("#message-main-receiver");

            $message_main_receiver.scrollTop($message_main_receiver.prop("scrollHeight"));
