                                        ...
                                        <li class="page-item">
                                            ...
                                            switch ($i) {
                                                case 0:
                                                    ?>
                                                    <a class="page-link"
                                                       href="/admin/earning.php?restaurentEarning=ok&page=1">First</a>
                                                    <?php
                                                    break;
                                                case 1:
                                                    if ($page > 2) {
                                                        ...
                                                        ?>
                                                        <a class="page-link"
                                                           href="/admin/earning.php?restaurentEarning=ok&page=<?php echo $page - 1 ?>">Previous</a>
                                                        <?php
                                                    }
                                                    break;
                                                case 2:
                                                    ...
                                                    <a class="page-link"<?php if ($page < 3) {
                                                       ...
                                                       href="/admin/earning.php?restaurentEarning=ok&page=<?php echo $page - 2; ?>"><?php echo $page - 2 ?></a>
                                                    <?php
                                                ...
                                                case 3:
                                                    ...
                                                    <a class="page-link" <?php if ($page < 2) {
                                                       ...
                                                       href="/admin/earning.php?restaurentEarning=ok&page=<?php echo $page - 1 ?>"><?php echo $page - 1 ?></a>
                                                    <?php
                                                    break;
                                                case 4:
                                                    ?>
                                                    <a class="page-link"
                                                       href="/admin/earning.php?restaurentEarning=ok&page=<?php echo $page ?>"><?php echo $page ?></a>
                                                    <?php
                                                    break;
                                                case 5:
                                                    ?>
                                                ...
                                                case 7:
                                                    if ($page < $total) {
                                                        ?>
                                                        <a class="page-link"
                                                           href="/admin/earning.php?restaurentEarning=ok&page=<?php echo $page + 1 ?>">Next</a>
                                                        <?php
                                                    }
                                                    break;
                                                case 8:
                                                    ?>
                                                    <a class="page-link"
                                                       href="/admin/earning.php?restaurentEarning=ok&page=<?php echo $total ?>">End</a>
                                                    <?php
                                                    break;
                                            }
                                            ?>
