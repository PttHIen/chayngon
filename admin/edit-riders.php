...
<?php if(isset($_SESSION['id'])) { ?>
    ...
    <div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
        ...
        <div class="main-content">
            ...
            <h2 class="toast-title">Edit riders</h2>
            <div class="panel-body">
                ...
                if(isset($_GET['upd'])) { //update user
                    if($_GET['upd']=="ok") {
                        ...
                        $note = htmlspecialchars($_POST['nte'], ENT_QUOTES);
                        if (isset($_POST['onl']) && $_POST['onl'].checked){
                            $online = htmlspecialchars('1', ENT_QUOTES);

                        }
                        else
                            $online = htmlspecialchars('0', ENT_QUOTES);
                ...
                if($json_data['code'] !== 200){
                    ...
                    ?>
                    <form role="form" method="post" action="edit-riders.php?user=<?php echo $uid; ?>&upd=ok" class="form-horizontal form-groups-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" name="phn" placeholder="Phone" value="<?php echo $json_data['msg']['UserInfo']['phone']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="nte" placeholder="note" value="<?php echo $json_data['msg']['UserInfo']['note']; ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <label  for="field-1" class="col-sm-2 control-label">online</label>
                                <div class="col-sm-6" >
                                    <input type="checkbox" name="onl" <?php if(isset($json_data['msg']['UserInfo']['online']) && $json_data['msg']['UserInfo']['online']=='1' )echo "checked";?> >
                                </div>
                        </div>
