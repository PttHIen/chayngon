<div class="sidebar-menu" style="min-height: 100vh;">
  <header class="logo-env"> 
    ...
    <!-- logo -->
    <div class="logo"> <a href="" style="font-size: 35px;font-weight: bold;"><img src="assets/images/logo1.png" alt="" style="width: 30px;"> ngon365 </div>
  ...
  <ul id="main-menu" class="">
    ...
    <!-- Search Bar -->
      ...
      <li> <a href="dashboard.php"><i class="entypo-users"></i> <span class="title">Bảng Điều Khiển</span> </a></li>
      ...
      <?php
          ...
          {
            ?>
              <li> <a href="users.php"><i class="entypo-users"></i> <span class="title">Danh Sach Tài Khoản</span> </a></li>
            <?php   
          }
      ?>      

      
      <li style="background:rgba(69, 74, 84, 0.3);"> <a href="#" style="padding: 5px 10px;"><span class="title">Quản Lý Nhà Hàng</span></a>

        <li> <a href="restaurants.php"><i class="entypo-home"></i> <span class="title">Nhà Hàng</span> </a></li>
