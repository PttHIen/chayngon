	...
	<link rel="stylesheet" type="text/css" href="/customer/css/style.css?1522155548" />
  ...
  <ul class="mainmenus_items" id="<?php echo $menuvalue['id']; ?>">
    ...
    <li>
      <div class="left col80">
          <div class="images"><img style="width: 200px" src="https://images.ngon365.com/<?php echo $value['image']; ?>"></div>
          <h3><?php echo $value['name']; ?> <span class="editlink"> <a href="javascript:;"
                                                                       data-main-menu-id="<?php echo $menuvalue['id']; ?>"
                                                                       data-menu-id="<?php echo $value['id']; ?>"
                                                                       data-menu-name="<?php echo $value['name']; ?>"
                                                                       data-menu-description="<?php echo $value['description']; ?>"
                                                                       data-menu-price="<?php echo $value['price']; ?>"
                                                                       data-out-of-stock="<?php echo $value['out_of_order']; ?>"
                                                                       class="main_menu_item_edit"><i
                              class="fa fa-pencil"></i></a> </span></h3>
