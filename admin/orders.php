...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->	
	...
	<div class="row">
        ...
        <div class="pull-right" style="margin:20px;">
            <span id="ordernotification" style="display:none">&nbsp;</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                        ...
                                        {
                                            echo "<b style='color:red;' >Từ chối</b>";
                                        }
                                        else if($data['Order']['hotel_accepted']=="0"){
                                            echo "<b style='color:red;' >Đang có</b>";
                                        }
                            ...
                            <td>
                                <?php
                                if($data['RiderOrder']['accept_reject_status']=="1" )
                                {
                                    echo "Accepted";
                                }
                                else
                                    if($data['RiderOrder']['accept_reject_status']=="2" )
                                    {
                                        echo "<b style='color:red;' >Rejected</b>";
                                    }
                                    else
                                        if($data['RiderOrder']['accept_reject_status']=="3" )
                                        {
                                            echo "Compelted";
                                        }
                            ...
                            <td> 
                                ...
                                <a href='javascript:;' onClick='getorder_status_details(<?php echo $data['Order']['id']; ?>)' class='btn btn-default btn-sm' style='cursor:pointer;'>Change Status</a>
                            </td>
...
function getorder_status_details($id)
{
    //alert('ad');
    jQuery('#modal-7').modal('show', {backdrop: 'static'});
            ...
            if( key == "OrderMenuItem" ) {
                 htmltext += '<div class="col-md-12"><h3>Order Menu Items</h3>';
                    ...
                    for ( var key1 in datakeyys ) { 
                        ...
                        htmuser_idltext += '<tr><td> Price:</td> <td> ' + datakeyys[key1].price + '</td> </tr>';
