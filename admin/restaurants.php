        ...
        <div class="main-content">
            ...
            <div class="row">
                <nav class="col-md-12">
                    ...
                    <div class="pull-right"><a style="position: relative; top: 10px;" href='import-restaurant.php'
                                               class='btn btn-default'>import data</a></div>
                    <div class="pull-right"><a style="position: relative; top: 10px;" href='add-restaurant.php'
                                               class='btn btn-default'>Add Restaurant</a></div>
                    <div class="pull-right">
                        <div class="box-seacrh" style="position: relative; top: 10px;">
                            <div class="input-group">
                                <form action="restaurants.php?page=1" method="get" style="display: inherit;margin-right: 2px;">
                                    <input type="text" class="form-control" style="height: 42px;" value="<?php echo $_GET['search'] ?>" placeholder="<?php echo $search ?>" id="txtSearch" name="search" />
                                    <div class="input-group-btn">
                                        <button class="btn btn-primary" type="submit" style="width: 64px;">
                    ...
                    <table id="table-1" class="display nowrap table table-hover table-striped table-bordered"
                        ...
                        $ch = curl_init($url);
                        $params = new stdClass();
                        $params->check["page"] = $page;
                        $params->check["search"] = $search;
                        ...
                        foreach ($items as $str => $data) {
                            ...
                            <td>
							 ...
							 <a href='manage_menu.php?resid=" . $data['Restaurant']['id'] . "&userid=" . $data['Restaurant']['user_id'] . "' class='btn btn-default btn-sm' style='margin-bottom:5px;' target='_blank'>Manage menu</a>
                                ...
                                ?>
                                <a href='javascript:;'
                                   onClick='editresto_details(<?php echo $data['Restaurant']['id']; ?>)'
                                   class='btn btn-default btn-sm' style='cursor:pointer;margin-bottom:5px;'>Edit
                                    Details</a>
                                <?php
                                //}
                                ...
                                if ($_SESSION['role'] == "0") {
                                    if ($data['Restaurant']['block'] == "0") {
                                        ...
                                        <a onClick="return confirm('Are you sure?')"
                                           href='restaurants.php?blockstatus=ok&id=<?php echo $data['Restaurant']['id']; ?>&block=1'
                                           class='btn btn-default btn-sm' style='cursor:pointer;margin-bottom:5px;'>Block </a>
                                        <?php
                                    } else
                                        if ($data['Restaurant']['block'] == "1") {
                                            ?>
                                            <a onClick="return confirm('Are you sure?')"
                                               href='restaurants.php?blockstatus=ok&id=<?php echo $data['Restaurant']['id']; ?>&block=0'
                                               class='btn btn-default btn-sm'
                                               style='cursor:pointer;margin-bottom:5px; background:red; color: white; '>Unblock </a>
                                            <?php
                                        }
                                }
                                ?>
                                            ...
                                            <li class="page-item">
                                                ...
                                                switch ($i) {
                                                    case 0:
                                                        ?>
                                                        <a class="page-link"
                                                           href="/admin/restaurants.php?page=1&search = <?php echo $search ?>">First</a>
                                                        <?php
                                                        break;
                                                    case 1:
                                                        if ($page > 2) {
                                                            ...
                                                            ?>
                                                            <a class="page-link"
                                                               href="/admin/restaurants.php?page=<?php echo $page - 1 ?>&search = <?php echo $search ?>">Previous</a>
                                                            <?php
                                                        }
                                                        break;
                                                    case 2:
                                                        ...
                                                        <a class="page-link"<?php if ($page < 3) {
                                                           ...
                                                           href="/admin/restaurants.php?page=<?php echo $page - 2; ?>&search = <?php echo $search ?>"><?php echo $page - 2 ?></a>
                                                        <?php
                                                    ...
                                                    case 3:
                                                        ...
                                                        <a class="page-link" <?php if ($page < 2) {
                                                           ...
                                                           href="/admin/restaurants.php?page=<?php echo $page - 1 ?>&search = <?php echo $search ?>"><?php echo $page - 1 ?></a>
                                                        <?php
                                                        break;
                                                    case 4:
                                                        ?>
                                                        <a class="page-link"
                                                           href="/admin/restaurants.php?page=<?php echo $page ?>&search = <?php echo $search ?>"><?php echo $page ?></a>
                                                        <?php
                                                        break;
                                                    case 5:
                                                        ?>
                                                    ...
                                                    case 7:
                                                        if ($page < $total) {
                                                            ?>
                                                            <a class="page-link"
                                                               href="/admin/restaurants.php?page=<?php echo $page + 1 ?>&search = <?php echo $search ?>">Next</a>
                                                            <?php
                                                        }
                                                        break;
                                                    case 8:
                                                        ?>
                                                        <a class="page-link"
                                                           href="/admin/restaurants.php?page=<?php echo $total ?>&search = <?php echo $search ?>">End</a>
                                                        <?php
                                                        break;
                                                }
                                                ?>
