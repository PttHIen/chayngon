<?php require_once("customer/header.php"); ?>

<div class="landingimage courier bgimage" style="background-image: url(customer/img/herro.jpg);">
  <div class="inner">
    <div class="wdth">
      <div class="topvh">
        <div class="col40 left">
          <h1>Ngon 365, ngon mỗi ngày</h1>
          <div class="wrap-router">
              <div class="slot">
                  <h3>Đối tác nhà hàng</h3>
                  <a class="button" href="https://ngon365.com/restaurant/">Tìm hiểu thêm</a>
              </div>
              <div class="slot">
                  <h3>Đối tác tài xế</h3>
                  <a class="button" href="https://ngon365.com/rider/">Tìm hiểu thêm</a>
              </div>
          </div>
        </div>
        <div class="col40 right">
          <h1>Ứng dụng của chúng tôi luôn sẵn sàng</h1>
            <div class="wrap-app">
                <div class="slot">
                    <a href="https://play.google.com/store/apps/details?id=com.vantinviet.foodies.android" target="_blank"><img src="customer/img/gplaystore.svg" alt="play store"></a>
                </div>
                <div class="slot">
                    <a href="https://itunes.apple.com/us/app/foodomia/id1357094450?mt=8" target="_blank"><img src="customer/img/appstore.svg" alt="apple store"></a>
                </div>
            </div>
        </div>
        <div class="clear"></div>
    ...
    <ul>
      <li>
        <div class="work-fonts">
          <div class="iconfont"><img src="customer/img/ico1.png" alt="Icon" /></div>
      ...
      <li>
        <div class="work-fonts">
          <div class="iconfont"><img src="customer/img/ico2.png" alt="Icon" /></div>
        </div>
      ...
      <li>
        <div class="work-fonts">
          <div class="iconfont"><img src="customer/img/ico3.png" alt="Icon" /></div>
        </div>
      ...
      <li>
        <div class="work-fonts">
          <div class="iconfont"><img src="customer/img/ico4.png" alt="Icon" /></div>
          </i></div>
...
<div class="mobrow bgimage" style="background:url(img/bgpatren.png);">
  <div class="wdth">
    <div class="left col40 textcenter" style="padding-top: 60px;"> <img src="customer/img/appscreen-sss.png" style="height: 255px;" alt=""> </div>
    <div class="right col60 section" style="padding-bottom: 0; padding-top: 140px;">
      ...
      <p class="logos"> <a href="https://play.google.com/store/apps/details?id=com.vantinviet.foodies.android" target="_blank"><img src="customer/img/gplaystore.svg" alt="play store"></a> <a href="https://itunes.apple.com/us/app/foodomia/id1357094450?mt=8" target="_blank"><img src="customer/img/appstore.svg" alt="apple store"></a> </p>
    </div>
    <div class="clear"></div>
  </div>
</div>
...
<?php require_once("customer/footer.php"); ?>