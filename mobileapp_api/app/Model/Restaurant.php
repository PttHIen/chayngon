...
public $hasMany = array(
    ...
    public function getNearByRestaurants($lat,$long,$user_id=null,$page=1)

    {
        ...
        return $this->find('all', array(
            ...
            'order' => 'distance','Restaurant.promoted DESC',
    ...
    public function getNearByRestaurants_search($lat,$long,$user_id,$page, $char_search)

    {
        ...
        return $this->find('all', array(
            ...
            'order' => 'distance','Restaurant.promoted DESC',
            'conditions' => array(
                'Restaurant.name LIKE' => '%'.$char_search.'%',
    ...
    public function getAdminRestaurants($page)
    {
        $this->Behaviors->attach('Containable');
    ...
    public function getAdminSearchRestaurants($page, $search)
    {
        $this->Behaviors->attach('Containable');
        $search = trim($search);
        return $this->find('all', array(
            'contain' => array('User', 'UserInfo'),
            'conditions' => array(
                'UserInfo.first_name LIKE' => '%'.$search.'%',
            ),
            'recursive' => 1,
            'limit' => 20,
            'page' => $page,
    ...
    public function getAdminTotalSearchRestaurants($search)
    {
        $this->Behaviors->attach('Containable');
