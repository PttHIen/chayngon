...
//
    ...
    public function getUserByEmail($email){ /* irfan function*/
    ...
    public function UserById($id){ /* irfan function*/
    ...
    public function verifyPassword($email,$old_password){
        ...
        if ($passwordHash == $userData['User']['password'] && $salt == $userData['User']['salt'] && $userData['User']['block'] == 0) {
    ...
    public function verify($email,$user_password)
    {
        ...
        if ($passwordHash == $userData[0]['User']['password'] && $salt == $userData[0]['User']['salt'] &&  $userData[0]['User']['block'] == 0) {
    ...
    public function getAllAdminUsers($page =1){
