	...
	<div class="left col40">
		...
		<div class="form">
			<form action="dashboard.php?p=changepassword&upd=ok" id="changepass" method="post">
                ...
                <label alt='Mật khẩu hiện tại' placeholder='Mật khẩu hiện tại'></label>
                </p>
                <p><input type="password"  id="newpas" name="newpas" required=''>
                 <label alt='Mật khẩu mới' placeholder='Mật khẩu mới'></label>
                </p>
				<p><input type="password" id="renewpas" name="renewpas" required=''>
                <label alt='Nhập lại mật khẩu mới' placeholder='Nhập lại mật khẩu mới'></label>
                </p>
