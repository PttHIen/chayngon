...
if (isset($_SESSION['id']) && $_SESSION['user_type'] == "hotel") {
    ...
    <div class="form" style="background:#F9F9F9; padding:40px 0px;  margin-bottom:100px;">
        ...
        <div align="center">
            ...
            <h2 style="font-size:50px; color:#BE2C2C; margin:20px ;"><?php echo $total_earning;
                echo $currency; ?></h2>
        ...
        <div style="padding:20px 0px; border-top:20px solid #f2f2f2">
            ...
            <table class="order_table" id="myTable" cellspacing="0" cellpadding="0" border="0">
                <thead>
                <tr>
                    <td style="font-weight: bold;"><strong>Ngày</strong></td>
                    <td style="font-weight: bold;" align="right"><strong>Thu nhập</strong></td>
                    <td>&nbsp;</td>
                </tr>
                </thead>
                ...
                if ($json_data['code'] == 200) {
                    foreach ($json_data['msg']['WeeklyEarning'] as $key => $value) {
                        ...
                        <tr style="display: table-row;">
                            <td><?php echo $value['week_start'] . " - ";
                                echo $value['week_end']; ?></td>
                            <td align="right">
                                        	<span class="blok" style="margin:0; color:green; font-weight:500;">
                                        	  <?php echo $value['total_earning'];
                                              echo $currency; ?>
                                            </span>
                            </td>
                            <td align="center"><a href="#"
                                                  style=" color:#be2c2c; text-decoration:none; font-weight:400;">Chi
                                    tiết</a></td>
