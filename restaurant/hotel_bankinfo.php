...
<h2 class="title">Thông tin ngân hàng</h2>
<?php 
if(isset($_GET['add'])) {
	if($_GET['add']=="inf") {
	...
	if($json_data == NULL) {
		...
		<div class="form col50 left">
			<form action="dashboard.php?p=bankinfo&add=inf" id="hotelbnkinffrm" method="post">
				<p><input type="text" name="nm" id="nm" placeholder="Họ và tên"></p>
				<p><input type="hidden" name="trnum" id="trnum" placeholder="Transit Number"></p>
				...
				foreach( $json_data['msg'] as $str => $val ) {
					...
					<div class="form col50 left">
						<form action="dashboard.php?p=bankinfo&edit=inf" id="hotelbnkinffrm" method="post">
							<p><input type="text" name="nm" id="nm" value="<?php echo $val['BankingInfo']['name']; ?>" required=''><label alt='Họ và tên' placeholder='Họ và tên'></label></p>
                           <div class="col50">
								<p><input type="hidden" name="trnum" id="trnum" value="<?php echo $val['BankingInfo']['transit_no']; ?>" required=''><label alt='Transit Number' placeholder='Transit Number'></label></p>
							</div>
							<div class="col50">
								<p><input type="text" name="bnkno" id="bnkno" placeholder="Mã ngân hàng" value="<?php echo $val['BankingInfo']['bank_no']; ?>" required=''><label alt='Mã ngân hàng' placeholder='Mã ngân hàng'></label></p>
							</div>
							<div class="clear" style="height: 15px;"></div>
							<p><input type="text" name="accno" id="accno" placeholder="Số tài khoản" value="<?php echo $val['BankingInfo']['account_no']; ?>" required=''><label alt='Số tài khoản' placeholder='Số tài khoản'></label></p>
							<p><input type="submit" value="Cập nhật" name=""></p>
						</form>
					</div>
					<div class="right col50">
						<img style="display: none" src="img/blankcheque_canadian.svg" alt="" />
					</div>
					<div class="clear"></div>
					<?php
