			...
			foreach( $json_data['msg'] as $stttr => $vaaal ) {
				...
				<div class="left col30" style="margin-right: 10px;">
					...
					<div class="itm"> 
						...
						<div class="cardtype right col40 textright"><strong><?php  echo $vaaal['Deal']['price']&ensp; echo $vaaal['Restaurant']['Currency']['symbol']; ?></strong></div>
						...
						<div align="right" style="margin-top:10px;">
							<a style="cursor: pointer;" data-id="<?php echo $vaaal['Deal']['id']; ?>" data-name="<?php echo $vaaal['Deal']['name']; ?>" data-price="<?php echo $vaaal['Deal']['price']&ensp; ?>" data-description="<?php echo $vaaal['Deal']['description']; ?>" data-expiry="<?php $exppr = explode(" ", $vaaal['Deal']['starting_time']); echo $exppr[0]; ?>" data-image="<?php echo $image_baseurl.$vaaal['Deal']['image']; ?>" data-cover="<?php echo $image_baseurl.$vaaal['Deal']['cover_image']; ?>" class="edit_icn" id="editit">Edit </a>
							| 
