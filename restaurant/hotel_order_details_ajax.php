			...
			if($json_data['code'] !== 200){
				...
				foreach( $json_data['msg'] as $str => $val ) {
					...
					<div class="orderinformation">
						...
						<h1 align="center" style="margin: 0px 0 20px 0;">Đơn hàng #<?php echo $order_id; ?></h1>
						<div class="sect">
						...
						<div class="sect">
														...
														echo "<tr height='0px'>
																<td colspan='3' style='padding:15px 15px 15px;'>
																	<span style='display:inline-block;padding-bottom:5px;border-bottom:0.5px solid #ccc;'>".
																		$value11['name']; ?> &nbsp;&nbsp; + 
																		<?php
																		echo $value11['price']; echo $currency."
																	</span>
																</td>
															</tr>";
							...
							<table width="100%" class="totalcad_table" cellpadding="0" cellspacing="0">
								...
								<tr height="30px">
									...
									<td style="padding:5px 0;"><strong>Thuế<span style="color:grey; font-size:12px;">(<?php echo $tax; ?>%)</span></strong></td>
								...
								<tr height="40px">
									...
									<td style="padding:5px 0;"><strong>Tổng <span style="color:grey; font-size:12px;">(Thanh toán)</span></strong></td>
                      ...
                      <ul>
                        <?php
							if($val['Order']['hotel_accepted']=="0")
							{
								?>
									<li>
                                      <a href="javascript:;" onClick="jQuery('#adddeals2').toggle();" class="filtericon acceptb"><span>Chấp nhận</span></a>
                                    </li>
                                    <li>
                                      <a href="javascript:;" onClick="jQuery('#reg').toggle();" class="filtericon acceptb"><span style="background: gray;">Từ chối</span></a>
                                    </li>
								<?php
							}
						?>
                        ...
                        <div class="popup_container col40"> <a href="javascript:;" onClick="jQuery('#reg').hide();" id="close">&times;</a>
                          <div class="paddingallsides form">
                            ...
                            <form action="dashboard.php?p=hotel_order&detail=<?php echo $_GET['orderID']; ?>&order=reject" id="hoteldealsfrmd" method="post">
                              <p>
                                <textarea class="textarea" name="reason" id="dsc" placeholder="Nhập lý do từ chối"></textarea>
                              </p>
                              <p>
