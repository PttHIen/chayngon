  ...
  <div id="page_content_sec">
    <div class="login_form">
      <div class="right col100 rightside">
        <div class="header"> Đăng nhập vào tài khoản của bạn </div>
        <div class="form">
        ...
        <div class="footer">Quên mật khẩu của bạn? <a class="forgetlinka">Quên?</a> </div>
      </div>
      <div class="clear"></div>
    </div>
  </div>
  <div id="forget">
    <div class="login_form">
      <div class="right col100 rightside">
        ...
        <div class="footer"> Bạn đã có tài khoản? <a class="signinform">Đăng nhập!</a> </div>
      </div>
      <div class="clear"></div>
    </div>
  </div>
