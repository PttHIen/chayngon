	...
	<div class="left col40">
		...
		<div class="form">
			<form action="dashboard.php?p=account&upd=ok" id="accoutinfo" method="post">
				<p><input type="text" placeholder="Họ" name="fname" id="fname" value="<?php echo $_SESSION['first_name']; ?>"></p>
				<p><input type="text" placeholder="Tên" name="lname" id="lname" value="<?php echo $_SESSION['last_name']; ?>"></p>
				<p><input type="text" placeholder="Số điện thoại" name="num" id="num" value="<?php echo $_SESSION['phone']; ?>" readonly></p>
				<p><input type="email" placeholder="Địa chỉ Email" name="eml" id="eml" value="<?php echo $_SESSION['email']; ?>" readonly></p>
				<p><input type="submit" value="Cập nhật thông tin"></p>
			</form>
		</div>
	</div>
