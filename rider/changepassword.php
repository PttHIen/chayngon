	...
	<div class="left col40">
		...
		<div class="form">
			<form action="dashboard.php?p=changepassword&upd=ok" id="changepass" method="post">
				<p><input type="password" placeholder="Mật khẩu cũ" id="oldpas" name="oldpas"></p>
				<p><input type="password" placeholder="Mật khẩu mới" id="newpas" name="newpas"></p>
				<p><input type="password" placeholder="Nhập lại mật khẩu" id="renewpas" name="renewpas"></p>
				<p><input type="submit" value="Cập nhật mật khẩu"></p>
			</form>
		</div>
	</div>
