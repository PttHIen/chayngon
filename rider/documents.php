...
<div class="right">
	<a href="javascript:;" onClick="jQuery('#adddoc').toggle();" class="filtericon"><i class="fa fa-plus"></i> <span>Thêm tài liệu</span></a>
</div>
<div class="clear"></div>
...
<div id="adddoc" class="popup">
	<div class="popup_container col40">
		...
		<div class="paddingallsides form">
			<h2 class="title">Thêm tài liệu</h2>
			<form action="dashboard.php?p=doc&add=ok" id="docfrm" method="post" enctype="multipart/form-data">
				<p><input type="text" name="docdesc" id="docdesc" placeholder="Mô tả" /></p>
				<p><input type="file" name="docfile" id="docfile" /></p>
				<p><input type="submit" value="Thêm tài liệu"></p>
			</form>
		</div>
...
<div class="form">
	<?php 
		...
		if($json_data['code'] !== 200){
			echo "<div class='alert alert-danger'>Lỗi khi tìm nạp phương thức thanh toán, hãy thử lại sau ..</div>";
