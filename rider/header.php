...
<div id="mySidenav" class="sidenav">
	<ul>
		<?php if( isset($_SESSION['id']) ){ ?>
			<li><a><span class="myacc">Tài khoản</span> <span class="nameontop"><?php echo $_SESSION['name']; ?></span></a>
				<ul class="sub-menu">
					<?php if( $_SESSION['user_type'] == "rider" ) { //rider ?>

							<li <?php if(isset($_GET['p'])) { if( $_GET['p'] == "order" ) {
								echo 'class="active"';
							} } ?> ><a href="dashboard.php?p=summary">Tổng quan <span class="blok">View work summary</span></a></li>

							<li <?php if(isset($_GET['p'])) { if( $_GET['p'] == "account" ) {
								echo 'class="active"';
							} } ?> ><a href="dashboard.php?p=account">Tài khoản của tôi <span class="blok">View or edit your account details</span></a></li>

							<li <?php if(isset($_GET['p'])) { if( $_GET['p'] == "changepassword" ) {
								echo 'class="active"';
							} } ?> ><a href="dashboard.php?p=changepassword">Thay đổi mật khẩu <span class="blok">Change your account password</span></a></li>

							<li <?php if(isset($_GET['p'])) { if( $_GET['p'] == "bankinfo" ) {
								echo 'class="active"';
							} } ?> ><a href="dashboard.php?p=bankinfo">Thông tin khác và ngân hàng <span class="blok">View or edit your bank details</span></a></li>
...
<header class="siteheader"><div class="wdth">
	<div class="logo left">
        <a href="index.php" style="text-decoration: none;"><img src="img/logo1.png?time=<?php echo time(); ?>" alt="" style="vertical-align: bottom" /><span style="height: 40px; text-decoration: none; color: #fff;     font-size: 36px;
    margin-left: 15px;">ngon365</span></a>
	</div>
				...
				<li class="lastmenu"><a><span class="myacc">Tài khoản</span> <span class="nameontop"><?php echo $_SESSION['name']; ?> <i class="fa fa-caret-down"></i></span></a>
					<ul class="submenu">
						<?php if( $_SESSION['user_type'] == "rider" ) { //rider ?>
							...
							<li <?php if(isset($_GET['p'])) { if( $_GET['p'] == "order" ) {
								echo 'class="active"';
							} } ?> ><a href="dashboard.php?p=summary">Tổng quan <span class="blok">Sơ lược tổng quan</span></a></li>

							<li <?php if(isset($_GET['p'])) { if( $_GET['p'] == "account" ) {
								echo 'class="active"';
							} } ?> ><a href="dashboard.php?p=account">Tài khoản của tôi <span class="blok">Xem và sửa chi tiết thông tin tài khoản</span></a></li>

							<li <?php if(isset($_GET['p'])) { if( $_GET['p'] == "changepassword" ) {
								echo 'class="active"';
							} } ?> ><a href="dashboard.php?p=changepassword">Đổi mật khẩu<span class="blok">Thay đổi mật khẩu</span></a></li>

							<li <?php if(isset($_GET['p'])) { if( $_GET['p'] == "bankinfo" ) {
								echo 'class="active"';
							} } ?> ><a href="dashboard.php?p=bankinfo">Thông tin khác và ngân hàng <span class="blok">Xem và sửa thông tin ngân hàng</span></a></li>
