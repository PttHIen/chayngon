	...
	if($json_data == NULL) {
		...
		<div class="form col50 left">
			<form action="dashboard.php?p=bankinfo&add=inf" id="hotelbnkinffrm" method="post">
				<p><input type="text" name="nm" id="nm" placeholder="Tên"></p>
				<p><input type="hidden" name="trnum" id="trnum" placeholder="Transit Number"></p>
				<p><input type="text" name="bnkno" id="bnkno" placeholder="Số tài khoản"></p>
				<p><input type="text" name="accno" id="accno" placeholder="Tên tài khoản"></p>
				<p><input type="submit" value="Thêm thông tin" name=""></p>
			</form>
		</div>
				...
				foreach( $json_data['msg'] as $str => $val ) {
					...
					<div class="form col50 left">
						<form action="dashboard.php?p=bankinfo&edit=inf" id="hotelbnkinffrm" method="post">
							<p><input type="text" name="nm" id="nm" placeholder="Tên" value="<?php echo $val['BankingInfo']['name']; ?>"></p>
							<div class="col50 left">
								<p><input type="hidden" name="trnum" id="trnum" placeholder="Số thẻ" value="<?php echo $val['BankingInfo']['transit_no']; ?>"></p>
							</div>
							<div class="col50 right">
								<p><input type="text" name="bnkno" id="bnkno" placeholder="Số thẻ ngân hàng" value="<?php echo $val['BankingInfo']['bank_no']; ?>"></p>
							</div>
							<div class="clear" style="height: 15px;"></div>
							<p><input type="text" name="accno" id="accno" placeholder="Nhập tên chủ thẻ" value="<?php echo $val['BankingInfo']['account_no']; ?>"></p>
							<p><input type="submit" value="Cập nhật thông tin" name=""></p>
						</form>
					</div>
					<div class="right col50">
						<img src="img/blankcheque_canadian.svg" alt="" />
