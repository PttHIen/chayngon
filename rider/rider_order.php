...
<div class="right">
	<a href="javascript:;" onClick="jQuery('#filtertoggle').toggle();" class="filtericon"><i class="fa fa-filter"></i> <span>Bộ lọc</span></a>
</div>
<div class="clear"></div>
<div id="filtertoggle" class="popup">
	<div class="popup_container">
		...
		<div class="paddingallsides">
			<h2 class="title">Bộ lọc tìm kiếm</h2>
			<form action="dashboard.php" id="get">
				<input type="hidden" name="p" value="summary" /><input type="hidden" name="filter" value="search" />
				<p><input type="text" name="start_date" placeholder="Ngày bắt đầu" id="datepicker" name="" /></p>
				<p><input type="text" name="end_date" placeholder="Ngày kết thúc" id="datepicker2" name="" /></p>
